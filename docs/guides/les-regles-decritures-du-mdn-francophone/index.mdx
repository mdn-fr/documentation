...
C'est également une chose à laquelle faire attention, la manière de traduire les mots peut varier en fonction du contexte, mais aussi des faux amis. Un exemple fréquent dans les pages que vous pouvez rencontrer est _inline_, _in line_, _in row_ et _online_.
