...
Cet élément ne prend aucun paramètre. C'est une version raccourcie de l'ancienne bannière `{{Deprecated_Header}}` sous le format d'une icône <Trash2 size={16} /> (icône de poubelle).
